...
```bash
bun install @cloudflare/realtimekit @cloudflare/realtimekit-react-ui
```

### Angular

```bash
bun install @cloudflare/realtimekit @cloudflare/realtimekit-angular-ui
```

### Web Components/HTML

```bash
bun install @cloudflare/realtimekit @cloudflare/realtimekit-ui
```
