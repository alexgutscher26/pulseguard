...
description: "How we designed PulseGuard's distributed check infrastructure for reliability, low latency, and horizontal scalability across 50+ global edge locations."
date: "2026-06-05"
category: "Engineering"
readTime: "12 min read"
author: "Alex Gutscher"
tags: ["monitoring architecture", "distributed systems", "Cloudflare Workers", "Durable Objects", "infrastructure"]
---

PulseGuard's monitoring infrastructure is built as a distributed mesh — a network of lightweight check nodes spread across 50+ global edge locations that coordinate to verify endpoint availability and response times. Here's how it works under the hood.

---

## High-Level Architecture Overview

At a high level, the system decouples into three distinct operational layers: **Edge Probes**, **Quorum State Coordinators**, and **Alert Dispatch Pipelines**:
...
+------+-------------+-------------+------+
| Edge Probe Node    Edge Probe Node      |  (50+ Cloudflare Locations)
| (Frankfurt)        (Virginia)           |
+------+-------------+-------------+------+
       |             |             |  (Sub-30ms RPC Consensus)
       v             v             v
+-----------------------------------------+
| MonitorChannel (Durable Object Actor)   |  (Quorum State Manager)
| - Aggregates 2/3 multi-region voting    |
...
Each layer is horizontally scalable, stateless at the edge, and coordinate via stateful actors to maintain high-throughput check aggregation.

---

## 1. Edge Probe Nodes

Each check probe is executed by an ephemeral Cloudflare Worker located at one of 50+ Points of Presence (POPs). When scheduled:
