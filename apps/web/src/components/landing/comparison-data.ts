...
export const featureComparisons: FeatureComparisonItem[] = [
  ...
  {
    category: "Core Monitoring",
    name: "Multi-Region Quorum",
    description: "Multi-region consensus verification for zero false positives",
    pulseguard: "7 Regions (4-of-7 Quorum)",
    uptimerobot: "4 regions (No quorum)",
    checkly: "15 regions (Parallel)",
    betteruptime: "4 locations (3-of-4 quorum)",
    competitor1: "4 regions",
    competitor2: "4 locations",
    competitor3: "Limited",
    isBattle: true,
  },
  {
