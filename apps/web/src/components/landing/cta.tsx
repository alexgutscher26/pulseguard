      ...
      <div className="max-w-4xl mx-auto px-6 relative z-20">
        <div className="border border-primary/50 bg-black p-8 md:p-12 relative flex flex-col items-center text-center gap-8 shadow-[0_0_50px_rgba(57,255,20,0.1)]">
          ...
          <div className="flex flex-col gap-3 w-full max-w-md">
            ...
            <Link
              href="/signup"
              className="flex w-full cursor-pointer items-center justify-center h-14 bg-primary text-black text-lg font-mono font-bold uppercase tracking-widest hover:bg-primary/90 transition-all border border-primary shadow-[0_0_20px_rgba(57,255,20,0.3)] hover:shadow-[0_0_40px_rgba(57,255,20,0.5)]"
            >
              &gt; Execute Setup
            </Link>
