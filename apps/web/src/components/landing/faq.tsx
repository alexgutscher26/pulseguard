    ...
    <section className="py-24 bg-muted/5" id="faq">
        <div className="max-w-3xl mx-auto px-6">
            <div className="mb-12 border-l-2 border-primary pl-6">
                <h2 className="text-foreground text-4xl font-black tracking-tighter uppercase font-mono">Knowledge Base</h2>
                <p className="text-muted-foreground font-mono mt-2">// QUERY: COMMON_ISSUES</p>
            </div>
            
            <div className="flex flex-col gap-4">
                {faqs.map((item, i) => (
                    <details key={i} className="group border border-border bg-background open:border-primary/50 transition-colors">
