  ...
  if (slug === "cyberpulse-api") {
    ...
    return {
      page: {
        ...
        barType: "absolute",
        cardType: "duration",
        homepageUrl: "https://steadystack.dev",
        contactUrl: "https://steadystack.dev/support",
        footerLinks: [
          { label: "Terms of Cyber-Service", url: "#" },
          { label: "Matrix Status", url: "#" },
        ],
        metaTitle: "CyberPulse API Status | SteadyStack Demo",
        metaDescription:
  ...
  if (slug === "neonstack-cloud") {
    ...
    return {
      page: {
        ...
        metaTitle: "NeonStack Cloud Status | SteadyStack Demo",
        metaDescription:
  ...
  if (slug === "void-games") {
    ...
    return {
      page: {
        ...
        homepageUrl: "https://steadystack.dev",
        contactUrl: "https://steadystack.dev/support",
        metaTitle: "Void Games Status | SteadyStack Demo",
        metaDescription:
  ...
  if (slug === "monochrome-saas") {
    ...
    return {
      page: {
        ...
        cardType: "duration",
        homepageUrl: "https://steadystack.dev",
        metaTitle: "Monochrome SaaS Status | SteadyStack Demo",
        metaDescription:
  ...
  if (slug === "quantum-mesh") {
    ...
    return {
      page: {
        ...
        cardType: "duration",
        homepageUrl: "https://steadystack.dev",
        metaTitle: "Quantum Mesh Status | SteadyStack Demo",
        metaDescription:
  ...
  if (slug === "datastream-cdn") {
    ...
    return {
      page: {
        ...
        homepageUrl: "https://steadystack.dev",
        contactUrl: "https://steadystack.dev/support",
        metaTitle: "DataStream CDN Status | SteadyStack Demo",
        metaDescription:
