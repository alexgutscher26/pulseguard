  ...
  useEffect(() => {
    if (activeProvider) {
      const savedToken = localStorage.getItem(
        `steadystack_token_${activeProvider}`,
      );
      if (savedToken) {
        setToken(savedToken);
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2">
        ...
        <p className="text-xs text-muted-foreground">
          ...
          SteadyStack connects directly to your providers.
        </p>
      </div>
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="space-y-3 p-4 rounded-xl border border-border bg-accent/10">
                          ...
                          <p className="text-[10px] text-muted-foreground leading-relaxed">
                            ...
                            paste it below. SteadyStack will persistently link
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="space-y-3 p-4 rounded-xl border border-border bg-accent/10">
                          ...
                          <p className="text-[10px] text-muted-foreground leading-relaxed">
                            ...
                            Settings and paste it below. SteadyStack will
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="space-y-3 p-4 rounded-xl border border-border bg-accent/10">
                          ...
                          <p className="text-[10px] text-muted-foreground leading-relaxed">
                            ...
                            below. SteadyStack will persistently link your
