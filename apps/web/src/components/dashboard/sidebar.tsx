      ...
      <div className="relative z-10 p-4 border border-border/80 bg-card/10 backdrop-blur-md flex flex-col gap-3.5 shadow-md rounded-none">
        <div className="flex flex-col gap-2 font-mono">
          <div className="flex items-center justify-between border-b border-border/40 pb-1.5">
            ...
            <span className="text-[9px] font-bold text-amber-500 bg-amber-500/10 px-1.5 py-0.5 border border-amber-500/20">
              FREE_DEV
            </span>
          </div>
          <div className="flex items-center justify-between text-[9px]">
            <span className="text-muted-foreground tracking-wider uppercase">PROBE NODES</span>
            <span className="text-foreground font-semibold">1 / 5 Enabled</span>
          </div>
          <div className="flex items-center justify-between text-[9px]">
            <span className="text-muted-foreground tracking-wider uppercase">PING INTERVAL</span>
            <span className="text-foreground font-semibold">60s Min</span>
          </div>
          <div className="flex items-center justify-between text-[9px]">
            <span className="text-muted-foreground tracking-wider uppercase">REGIONS</span>
            <span className="text-foreground font-semibold">US-East Only</span>
          </div>
        </div>
        ...
        <Link
          ...
          className="w-full bg-foreground text-background text-xs font-bold uppercase tracking-wider hover:bg-emerald-400 hover:text-black hover:shadow-[0_0_15px_rgba(52,211,153,0.3)] transition-all duration-300 py-2.5 flex items-center justify-center gap-1.5 cursor-pointer rounded-none border border-foreground/10"
        >
