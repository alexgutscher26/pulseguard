...
export function MonitorForm() {
  return (
    <div className="max-w-2xl mx-auto flex flex-col gap-8">
      ...
      <form action={createMonitor} className="bg-black/40 border border-primary/20 p-8 backdrop-blur-sm relative group">
          {/* Decor */}
            ...
            <div className="grid grid-cols-2 gap-4">
                 <div className="flex flex-col gap-1.5">
                    ...
                    <div className="relative">
                        ...
                        <select name="interval" className="bg-black/50 border border-primary/20 focus:border-primary/60 text-primary text-sm rounded-sm p-3 pl-10 font-mono focus:outline-none focus:ring-1 focus:ring-primary/20 transition-all w-full appearance-none">
                 ...
                 <div className="flex flex-col gap-1.5">
                    <label className="text-[10px] font-bold text-primary/70 uppercase tracking-widest font-mono">Request Timeout</label>
                     <div className="relative">
                        <Clock className="absolute top-3 left-3 size-4 text-primary/40" />
                        <select name="timeout" className="bg-black/50 border border-primary/20 focus:border-primary/60 text-primary text-sm rounded-sm p-3 pl-10 font-mono focus:outline-none focus:ring-1 focus:ring-primary/20 transition-all w-full appearance-none">
