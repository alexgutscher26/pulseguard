      ...
      <section className="bg-black/40 border border-primary/20 relative overflow-hidden backdrop-blur-sm">
        ...
        <div className="p-6 flex flex-col gap-4">
          {apiKeys.map((key) => (
            <div
              key={key.id}
              className="border border-primary/10 bg-primary/5 p-4 flex flex-col md:flex-row items-center justify-between gap-4 group hover:border-primary/30 transition-all"
            >
              <div className="flex items-center gap-4 w-full md:w-auto">
                ...
                <div className="flex flex-col">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="bg-primary/20 text-primary text-[9px] px-1.5 py-0.5 rounded-sm uppercase tracking-wider font-bold">
                      Active
                    </span>
                  </div>
              ...
              <div className="flex items-center gap-6 w-full md:w-auto justify-between md:justify-end">
                <div className="flex flex-col items-end md:items-end">
                  <span className="text-[10px] text-primary/40 font-mono uppercase tracking-wider">
                    Last Used
                  </span>
                ...
                <div className="flex items-center gap-2">
                  <button
                    className="p-2 hover:bg-primary/10 text-primary/50 hover:text-primary transition-colors"
                    title="Copy Key"
                  >
                    <Copy className="size-4" />
                  </button>
                  <button
                    className="p-2 hover:bg-red-500/10 text-primary/50 hover:text-red-500 transition-colors"
                    title="Revoke Key"
                  >
