      ...
      <div className="p-6 flex flex-col md:flex-row items-center justify-between gap-4">
        <div className="flex items-start gap-4">
            ...
            <div className="flex flex-col">
                <h3 className="text-lg font-bold text-red-500 font-mono uppercase tracking-tight">Danger Zone</h3>
                <p className="text-xs text-red-500/70 font-mono">Permanently delete account and all associated data. This action is irreversible.</p>
            </div>
        </div>
