  ...
  return (
    <section className="bg-black/40 border border-primary/20 relative overflow-hidden backdrop-blur-sm group hover:border-primary/40 transition-all">
      ...
      <div className="p-6 border-b border-primary/20 bg-primary/5">
        <h3 className="text-lg font-bold text-foreground font-mono uppercase tracking-tight">Profile Information</h3>
        <p className="text-xs text-primary/60 font-mono">Update operator identity and credentials</p>
      </div>
      ...
      <div className="p-6 flex flex-col gap-6">
        <div className="flex items-center gap-6">
          ...
          <div className="flex flex-col gap-3">
            ...
            <p className="text-[10px] text-primary/40 font-mono">ACCEPTED: JPG, GIF, PNG. MAX: 800KB</p>
          </div>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="flex flex-col gap-1.5">
            <label className="text-[10px] font-bold text-primary/70 uppercase tracking-widest font-mono">Full Name</label>
            <input
          ...
          <div className="flex flex-col gap-1.5">
            <label className="text-[10px] font-bold text-primary/70 uppercase tracking-widest font-mono">Email Protocol</label>
            <input
              className="bg-black/50 border border-primary/20 focus:border-primary/60 text-primary text-sm rounded-sm p-2.5 font-mono placeholder:text-primary/20 focus:outline-none focus:ring-1 focus:ring-primary/20 transition-all"
              type="email"
