      ...
      <div className="flex flex-col lg:flex-row gap-12 items-start">
        <div className="flex-1 flex flex-col gap-6">
          ...
          <p className="text-muted-foreground text-sm sm:text-base leading-relaxed max-w-lg">
            Solo devs hate waking up for false alarms. SteadyStack runs every
            check through a{" "}
            ...
            <div className="flex flex-col gap-4 relative">
              ...
              <div className="border-t border-border/40 pt-3 mt-1">
                <p className="text-[11px] text-muted-foreground font-mono leading-relaxed text-center">
                  SteadyStack&apos;s 5-vector verification completes in &lt;1.8s
      ...
      <section className="flex flex-col gap-10">
        <div className="max-w-2xl">
          ...
          <p className="text-muted-foreground text-sm leading-relaxed">
            Beyond vector verification, SteadyStack deploys intelligent dampers
