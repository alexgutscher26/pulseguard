      ...
      <section className="py-28 md:py-36 bg-background relative overflow-hidden border-b border-border">
        ...
        <div className="max-w-5xl mx-auto px-6 md:px-12 flex flex-col items-center text-center gap-6 relative">
          ...
          <p className="text-muted-foreground text-sm leading-relaxed max-w-xl">
            ...
            &ldquo;standard.&rdquo; We think that&apos;s a relic. SteadyStack
            gives you{" "}
        ...
        <div className="max-w-5xl mx-auto px-6 md:px-12">
          <div className="max-w-3xl">
            ...
            <p className="text-muted-foreground text-sm leading-relaxed mb-10">
              Scroll through the check intervals side by side.
              SteadyStack&apos;s free 1-minute interval means you detect
              problems before your competitors even run their first check.
            </p>
          </div>
          <IntervalComparison />
        </div>
        ...
        <div className="max-w-5xl mx-auto px-6 md:px-12">
          <div className="max-w-3xl">
            ...
            <p className="text-muted-foreground text-sm leading-relaxed mb-10">
              ...
              SteadyStack&apos;s faster check interval catches failures up to 4
      ...
      <section className="py-20 bg-background relative overflow-hidden border-b border-border">
        <div className="max-w-5xl mx-auto px-6 md:px-12">
          <div className="max-w-3xl">
            ...
            <p className="text-muted-foreground text-sm leading-relaxed mb-10">
              Adjust the slider to see how SteadyStack&apos;s faster checks
      ...
      <section className="py-20 bg-background relative overflow-hidden border-b border-border">
        <div className="max-w-5xl mx-auto px-6 md:px-12">
          <div className="max-w-3xl">
            ...
            <p className="text-muted-foreground text-sm leading-relaxed mb-10">
              SteadyStack doesn&apos;t just win on check intervals. See how we
