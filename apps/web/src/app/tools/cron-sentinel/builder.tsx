  ...
  return (
    <div className="space-y-8 max-w-4xl mx-auto">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="space-y-6">
          <Card className="border-primary/20 bg-card/40 backdrop-blur-xl">
             <CardHeader>
                <div className="flex items-center gap-3">
                   ...
                   <div>
                      <CardTitle className="font-mono uppercase tracking-tighter italic text-lg leading-none">Sequence Input</CardTitle>
                      <CardDescription className="font-mono text-[10px] opacity-60 uppercase tracking-widest mt-1">Configure your execution trigger</CardDescription>
                   </div>
                </div>
             </CardHeader>
             <CardContent className="space-y-6">
                <div className="space-y-2">
                   <label className="text-[10px] font-mono text-primary/60 uppercase tracking-widest pl-1">CRON EXPRESSION</label>
                ...
                <div className="pt-4 space-y-3">
                   <div className="text-[10px] font-mono text-foreground/40 uppercase tracking-widest pl-1 italic">// Quick Presets</div>
                      ...
                      {presets.map(p => (
                        <Button 
                          ...
                          className={cn(
                            ...
                            cron === p.val ? "bg-primary/20 border-primary/40 text-primary" : "hover:border-primary/30"
                          )}
                ...
                <div className="mt-8 p-4 bg-primary/5 border-l-2 border-primary rounded-sm space-y-1">
                   <div className="text-[9px] font-mono text-primary uppercase font-bold tracking-[0.2em]">Human Translation</div>
          ...
          <Card className="border-primary/20 bg-linear-to-br from-primary/10 to-transparent p-6 text-center space-y-4">
             <h3 className="font-mono text-sm uppercase font-bold italic tracking-tighter">Ready to Deploy Schedule?</h3>
             <Button 
              ...
              <CardHeader className="bg-white/5 border-b border-white/5">
                 <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                       ...
                       <span className="font-mono text-xs uppercase text-primary font-bold tracking-widest">Execution Timeline</span>
                    </div>
                    <Badge variant="outline" className="text-[8px] font-mono uppercase border-primary/20 text-primary/60">Real-Time Simulation</Badge>
                 </div>
              </CardHeader>
                    ...
                    <div className="flex items-start gap-3">
                       ...
                       <div className="space-y-2">
                          <p className="text-[10px] font-mono text-foreground/60 leading-relaxed uppercase tracking-tighter italic">
                             Execution nodes are distributed across 350+ edge locations. Timestamps reflect regional synchronization.
                          </p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-12 border-t border-primary/10">
         {[
           { title: "Standard CRON", desc: "Supports classic 5-part Linux cron semantics (Minute, Hour, Day, Month, Week).", icon: <Clock className="w-4 h-4" /> },
           { title: "Edge Scheduling", desc: "PulseGuard triggers monitors at precisely these intervals across the global CDN.", icon: <Zap className="w-4 h-4" /> },
           { title: "Conflict Check", desc: "Built-in validation ensures your cron sequences don't overlap or cause race conditions.", icon: <AlertCircle className="w-4 h-4" /> },
         ].map(feat => (
           <div key={feat.title} className="space-y-2 p-4 rounded-lg hover:bg-primary/5 transition-colors">
