...
const MOCK_ASSETS = {
  "google.com": {
    before: "https://images.unsplash.com/photo-1573804633927-bfcbcd909acd?q=80&w=1200&auto=format&fit=crop",
    after: "https://images.unsplash.com/photo-1542744094-3a31f272c490?q=80&w=1200&auto=format&fit=crop",
  },
  "pulseguard.ai": {
    before: "https://images.unsplash.com/photo-1550751827-4bd374c3f58b?q=80&w=1200&auto=format&fit=crop",
    after: "https://images.unsplash.com/photo-1558494949-ef010ca66221?q=80&w=1200&auto=format&fit=crop",
  }
};
...
export function VisualDiffComparator() {
  ...
  // Mock URLs (Demo)
  const imgA = url1.includes("google") ? MOCK_ASSETS["google.com"].before : MOCK_ASSETS["pulseguard.ai"].before;
  const imgB = url2 || url1.includes("google") ? MOCK_ASSETS["google.com"].after : MOCK_ASSETS["pulseguard.ai"].after;
                ...
                <form onSubmit={startAnalysis} className="space-y-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-4">
                      <Label className="text-[10px] uppercase font-bold tracking-[2px] text-primary/70">Point A (Reference)</Label>
                    ...
                    <div className="space-y-4">
                      <Label className="text-[10px] uppercase font-bold tracking-[2px] text-secondary/70">Point B (Target Mutation)</Label>
                      <div className="relative group/input">
                        <Input 
        ...
        {isScanning && (
          ...
          >
            ...
            <div className="space-y-4 max-w-md">
              <GlitchText text="CAPTURING GRID DATA" className="text-2xl font-black uppercase italic tracking-tighter" />
          ...
          >
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
              <div className="flex items-center gap-4">
                <Badge variant="outline" className="text-primary border-primary bg-primary/10 rounded-none px-3 py-1 font-mono uppercase italic">
                  Mutation Detected
                </Badge>
              ...
              <CardContent className="p-0 select-none">
                  ...
                  >
                    ...
                    >
                      ...
                      <div className="absolute top-4 left-4 z-20">
                        <Badge className="bg-primary/80 backdrop-blur-sm italic uppercase tracking-tighter">Reference</Badge>
                      </div>
                    </div>

                    <div className="absolute top-4 right-4 z-20">
                      <Badge className="bg-secondary/80 backdrop-blur-sm italic uppercase tracking-tighter">Mutation</Badge>
                    </div>
                ...
                {viewMode === "heatmap" && (
                  <div className="relative aspect-video w-full bg-black group overflow-hidden">
                    <img src={imgA} className="absolute inset-0 h-full w-full object-cover opacity-30 grayscale" />
                    <div className="absolute inset-0 flex items-center justify-center">
                       {/* Simulated Heatmap Mask */}
                       <div className="absolute inset-0 mix-blend-screen overflow-hidden">
                          <img src={imgB} className="h-full w-full object-cover opacity-50 sepia-[1] hue-rotate-[320deg] animate-pulse" />
                       </div>
                    </div>
                    ...
                    <div className="absolute top-4 left-4 z-20">
                      <Badge variant="destructive" className="italic uppercase tracking-tighter animate-bounce flex gap-1">
                ...
                {viewMode === "side" && (
                  <div className="grid grid-cols-2 gap-px bg-primary/20 aspect-video">
                    <div className="relative overflow-hidden group">
                      <img src={imgA} className="h-full w-full object-cover grayscale group-hover:grayscale-0 transition-all duration-700" title="Reference" />
                      <div className="absolute bottom-4 left-4">
                        <Badge className="bg-black/60 border-primary text-primary italic uppercase text-[8px]">09:00 AM - REF_SNAPSHOT</Badge>
                      </div>
                    </div>
                    <div className="relative overflow-hidden group">
                      <img src={imgB} className="h-full w-full object-cover border-l border-primary/30" title="Mutation" />
                      <div className="absolute bottom-4 left-4">
                        <Badge variant="destructive" className="bg-black/60 italic uppercase text-[8px]">10:45 AM - DETECTED_DIFF</Badge>
                      </div>
                    </div>
                  </div>
                )}
