...
export const CLOUDFLARE_PROBE_REGIONS: Region[] = [
  {
    ...
    ipv4Ranges: ["104.16.0.0/13", "172.64.0.0/13"],
  ...
  },
  {
    ...
    ipv4Ranges: ["104.24.0.0/14", "172.70.0.0/15"],
    ipv6Ranges: ["2606:4700::/32"],
    isCloudflareDO: true,
    defaultHealthStatus: "ONLINE",
  },
  {
    ...
    ipv4Ranges: ["104.28.0.0/14", "172.68.0.0/15"],
    ipv6Ranges: ["2606:4700::/32"],
    isCloudflareDO: true,
    defaultHealthStatus: "ONLINE",
  },
  {
    ...
    ipv4Ranges: ["104.20.0.0/14", "172.66.0.0/15"],
    ipv6Ranges: ["2606:4700::/32"],
    isCloudflareDO: true,
    defaultHealthStatus: "ONLINE",
  },
  ...
  },
  {
    ...
    ipv4Ranges: ["104.22.0.0/15", "172.69.0.0/16"],
    ipv6Ranges: ["2606:4700::/32"],
    isCloudflareDO: true,
    defaultHealthStatus: "ONLINE",
  },
