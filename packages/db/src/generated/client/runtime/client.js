  ...
  hi = (e, t, r, n) => {
    if ((t && typeof t == "object") || typeof t == "function")
      for (let i of Xl(t))
        !tu.call(e, i) &&
          i !== r &&
          Qt(e, i, { get: () => t[i], enumerable: !(n = Yl(t, i)) || n.enumerable });
    return e;
  };
var U = (e, t, r) => (
    (r = e != null ? Zl(eu(e)) : {}),
    hi(t || !e || !e.__esModule ? Qt(r, "default", { value: e, enumerable: !0 }) : r, e)
  ),
...
var Ys = V((C) => {
  ...
  for (let e = 0, t = Rt, r = 1, n = 0; e < 24; e++) {
    ...
    let i = Gp;
    for (let o = 0; o < 7; o++)
      ((t = ((t << Rt) ^ ((t >> Wp) * Zp)) % Kp), t & zp && (i ^= Rt << ((Rt << BigInt(o)) - Rt)));
    Ws.push(i);
  }
  var [Yp, Xp] = (0, kt.split)(Ws, !0),
    Js = (e, t, r) => (r > 32 ? (0, kt.rotlBH)(e, t, r) : (0, kt.rotlSH)(e, t, r)),
    Hs = (e, t, r) => (r > 32 ? (0, kt.rotlBL)(e, t, r) : (0, kt.rotlSL)(e, t, r));
  function Ks(e, t = 24) {
...
var Xr,
  ...
  vi = !0;
typeof process < "u" &&
  (({ FORCE_COLOR: Xr, NODE_DISABLE_COLORS: Ti, NO_COLOR: Si, TERM: Ai } = process.env || {}),
...
function Pu(e) {
  let t = {
    ...
    r = (...n) => {
      ...
      if (
        (n.length !== 0 && lt.push([o, ...n]), lt.length > xu && lt.shift(), ut.enabled(o) || i)
      ) {
        let l = n.map((c) => (typeof c == "string" ? c : Tu(c))),
          u = `+${Date.now() - ki}ms`;
        ((ki = Date.now()),
          globalThis.DEBUG_COLORS ? a(Jt[s](Q(o)), ...l, Jt[s](u)) : a(o, ...l, u));
      }
    };
          ...
          for (let $ = n, le = i; $ < t.length; le += t[$].length, ++$) {
            ...
            if (ke && $ != t.length - 1) {
              ...
              var c = p.index + (j ? p[1].length : 0),
                ...
                a = $,
                l = le;
              for (let Kl = t.length; a < Kl && (l < d || (!t[a].type && !t[a - 1].greedy)); ++a)
...
function Gu(e, t) {
  ...
  if (o && (o.getField(n)?.markAsError(), i))
    for (let s of i.fields) s.isRelation && o.addSuggestion(new q(s.name, "true"));
  t.addErrorMessage((s) => {
...
function oo(e, t, r) {
  let n = [`Unknown argument \`${e.red(t)}\`.`],
    i = dc(t, r);
  return (
    i && n.push(`Did you mean \`${e.green(i)}\`?`), r.length > 0 && n.push(yt(e)), n.join(" ")
  );
}
function rc(e, t) {
  let r;
...
function lc(e, t) {
  for (let r of t.fields)
    r.isRelation && !e.hasField(r.name) && e.addSuggestion(new q(r.name, "true"));
}
function uc(e, t) {
  for (let r of t.fields)
    !e.hasField(r.name) && !r.isRelation && e.addSuggestion(new q(r.name, "true"));
}
function cc(e, t) {
...
function uo(e, t) {
  if (t.kind === "object")
    for (let r of t.fields)
      e.hasField(r.name) || e.addSuggestion(new q(r.name, r.typeNames.join(" | ")));
}
function Ve(e) {
  let t = [...e],
    r = t.pop();
...
function ho(e, t, r) {
  ...
  return !t.result || !(t.result.$allModels || t.result[n])
    ? e
    : fc({ ...e, ...yo(t.name, e, t.result.$allModels), ...yo(t.name, e, t.result[n]) });
}
function fc(e) {
  let t = new z(),
    r = (n, i) =>
...
function Qe(e = {}) {
  ...
  return Object.entries(t).reduce(
    (n, [i, o]) => (No[i] !== void 0 ? (n.select[i] = { select: o }) : (n[i] = o), n),
    { select: {} },
  );
}
function qc(e = {}) {
...
var $o = (e) => (Array.isArray(e) ? e : e.split(".")),
  ...
  Vo = (e, t, r) =>
    $o(t).reduceRight((n, i, o, s) => Object.assign({}, bn(e, s.slice(0, o)), { [i]: n }), r);
function Jc(e, t) {
...
function vn(e, t, r, n) {
  switch (r.type) {
    ...
    case "decimal":
      if (typeof e != "number" && typeof e != "string" && !cs.Decimal.isDecimal(e))
...
function cd(e) {
  (!Se || Se.length < e
    ? ((Se = Buffer.allocUnsafe(e * ud)), $n.webcrypto.getRandomValues(Se), (We = 0))
...
function md(e) {
  let t = fd(),
    r = (t && (t.crypto || t.msCrypto)) || (typeof Dt.default < "u" ? Dt.default : null);
...
function yd(e, t = pa) {
  ...
  if (e > ua)
    throw new ve(Ae.EncodeTimeSizeExceeded, `Cannot encode a time larger than ${ua}: ${e}`);
    ...
    case "templateSql":
      return (e.chunkable ? kd(e.fragments, i, n) : [i]).map((s) => {
        if (n !== void 0 && s.length > n)
          throw new I("The query parameter limit supported by your database is exceeded.", "P2029");
      ...
      case "execute": {
        ...
        for (let o of n) {
          ...
          i += await this.#l(s, r.queryable, () =>
            r.queryable.executeRaw(s).catch((a) => (t.args.type === "rawSql" ? An(a) : He(a))),
          );
        }
        return { value: i };
      }
        ...
        for (let o of n) {
          let s = Sa(o, r.sqlCommenter),
            a = await this.#l(s, r.queryable, () =>
              r.queryable.queryRaw(s).catch((l) => (t.args.type === "rawSql" ? An(l) : He(l))),
            );
...
var $d = 100,
  ...
  jd = () => ({ sql: '-- Implicit "COMMIT" query via underlying driver', args: [], argTypes: [] }),
  Ud = () => ({
  ...
  $t = class {
    ...
    async #r(t) {
      ...
      switch (
        ...
        case "waiting":
          if (n.signal.aborted)
            throw (
              o.then((s) => s.rollback()).catch((s) => Xe("error in discarded transaction:", s)),
    ...
    #n(t, r) {
      ...
      if (!n) {
        ...
        if (i)
          switch (
            (Xe("Transaction already closed.", { transactionId: t, status: i.status }), i.status)
          ) {
            case "closing":
            case "waiting":
            case "running":
      ...
      let n = Date.now(),
        i = Ra(async () => {
          ...
          o && ["running", "waiting"].includes(o.status)
            ...
            : Xe("Transaction already committed or rolled back when timeout happened.", t);
        }, r);
      return (i?.unref?.(), i);
    }
    async #o(t, r) {
      let n = async () => {
        ...
        try {
          ...
          ((t.status = r),
            ...
            this.closedTransactions.length > $d && this.closedTransactions.shift());
        }
      };
      t.status === "closing"
...
function Xa(e) {
  ...
  if (o === null || o.length < 1)
    throw new Ce("Error validating `accelerateUrl`: the URL must contain a valid API key", t);
...
var qt = class {
  ...
  #c(t, r) {
    ...
    if (t.code === "GenericFailure" && t.message?.startsWith("PANIC:"))
      return new D.PrismaClientRustPanicError(il(this, t.message, r), this.config.clientVersion);
    if (t instanceof I)
    ...
    try {
      ...
      if (((global.PRISMA_WASM_PANIC_REGISTRY.set_message = i), o))
        throw (
          ...
          new D.PrismaClientRustPanicError(il(this, o, r), this.config.clientVersion)
        );
    }
  }
  onBeforeExit() {
  ...
  async request(t, { interactiveTransaction: r, customDataProxyFetch: n }) {
    ...
    if (ol(t)) s = sl(t);
      ...
      p
        ...
        : (ae("query plan cache miss"), (s = this.#h(l, c, o)), this.#i.setSingle(c, s));
    }
    try {
...
var sm = /^(\s*alter\s)/i,
  yl = F("prisma:client");
function ui(e, t, r, n) {
  if (!(e !== "postgresql" && e !== "cockroachdb") && r.length > 0 && sm.exec(t))
...
var ci =
    ...
    (r) => {
      let n = "",
        i;
      if (mr(r)) ((n = r.sql), (i = { values: et(r.values), __prismaRawParameters__: !0 }));
        ...
        switch (t) {
          ...
          case "sqlserver": {
            ((n = cl(r)), (i = { values: et(r.values), __prismaRawParameters__: !0 }));
            break;
          }
          default:
      ...
      return (
        i?.values ? yl(`prisma.${e}(${n}, ${i.values})`) : yl(`prisma.${e}(${n})`),
    ...
    constructor(t, r) {
      ((this.logEmitter = r),
        ...
        (this.dataloader = new Hr({
          ...
          batchBy: (n) =>
            n.transaction?.id ? `transaction-${n.transaction.id}` : Cl(n.protocolQuery),
          batchOrder(n, i) {
...
`,
    ...
    _request(n) {
      ...
      return this._tracingHelper.runInChildSpan(s.operation, () =>
        new Ul.AsyncResource("prisma-client-request").runInAsyncScope(() => a(o)),
      );
    }
