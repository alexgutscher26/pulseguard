  ...
  zi = (e, t, r, n) => {
    if ((t && typeof t == "object") || typeof t == "function")
      for (let i of Ll(t))
        !Fl.call(e, i) &&
          i !== r &&
          hr(e, i, { get: () => t[i], enumerable: !(n = Ml(t, i)) || n.enumerable });
    return e;
  };
var Qe = (e, t, r) => (
    (r = e != null ? Dl(_l(e)) : {}),
    zi(t || !e || !e.__esModule ? hr(r, "default", { value: e, enumerable: !0 }) : r, e)
  ),
  Ki = (e) => zi(hr({}, "__esModule", { value: !0 }), e);
function In(e, t) {
  if (((t = t.toLowerCase()), t === "utf8" || t === "utf-8")) return new h(ql.encode(e));
  ...
  u = ye(() => {
    ...
    h = class e extends Uint8Array {
      ...
      toString(t = "utf8", r = 0, n = this.length) {
        ...
        if (t === "binary" || t === "ascii" || t === "latin1" || t === "latin-1")
          return this.slice(r, n).reduce((i, o) => i + kn(o & (t === "ascii" ? 127 : 255)), "");
        if (t === "ucs2" || t === "ucs-2" || t === "utf16le" || t === "utf-16le") {
...
function no(e, t) {
  ...
  for (t == null ? ((B = !1), (a = A)) : (a = t), s = new T(0.03125); e.abs().gte(0.1); )
    ((e = e.times(s)), (f += 5));
  for (
...
function On(e, t, r) {
  if (t > e.LN10.sd())
    throw ((B = !0), r && (e.precision = r), Error(ce + "LN10 precision limit exceeded"));
...
function Nt(e, t) {
  ...
  if (
    ((f += C), (R.precision = f), (r = he(M)), (n = r.charAt(0)), (o = G(S)), Math.abs(o) < 15e14)
  ) {
    for (; (n < 7 && n != 1) || (n == 1 && r.charAt(1) > 3); )
      ((S = S.times(e)), (r = he(S.d)), (n = r.charAt(0)), A++);
    ((o = G(S)), n > 1 ? ((S = new R("0." + r)), o++) : (S = new R(n + "." + r.slice(1))));
  } else
    return (
  ...
  for (a = s = S = Re(S.minus(ue), S.plus(ue), f), T = _(S.times(S), f), i = 3; ; ) {
    if (
      ((s = _(s.times(T), f)),
        ...
        r < 4
          ...
          : a > 5 ||
            (a == 5 &&
              (r == 4 ||
                m ||
                (r == 6 && ((n > 0 ? (i > 0 ? f / Je(10, s - i) : 0) : A[T - 1]) % 10) & 1) ||
                r == (e.s < 0 ? 8 : 7))))),
    t < 1 || !A[0])
  )
    return (
...
function io(e, t) {
  var r,
    ...
    C = e.constructor,
    S = C.precision;
  if (!e.s || !t.s) return (t.s ? (t.s = -t.s) : (t = new C(e)), B ? _(t, S) : t);
  if (((m = e.d), (A = t.d), (n = t.e), (f = e.e), (m = m.slice()), (s = f - n), s)) {
    for (
      T = s < 0,
        T ? ((r = m), (s = -s), (a = A.length)) : ((r = A), (n = f), (a = m.length)),
  ...
  for (T && ((r = m), (m = A), (A = r), (t.s = -t.s)), a = m.length, i = A.length - a; i > 0; --i)
    m[a++] = 0;
  for (i = A.length; i > s; ) {
    if (m[--i] < A[i]) {
...
function oo(e) {
  ...
  function i(o) {
    ...
    if ((o.charCodeAt(0) === 45 ? ((o = o.slice(1)), (s.s = -1)) : (s.s = 1), Gl.test(o))) Xi(s, o);
...
function Wl(e) {
  ...
  var t,
    r,
    n,
    i = ["precision", 1, ot, "rounding", 0, 8, "toExpNeg", -1 / 0, 0, "toExpPos", 0, 1 / 0];
...
var ot,
  ...
  ao = ye(() => {
    ...
    v.logarithm = v.log = function (e) {
      ...
      return r.eq(ue) ? new n(0) : ((B = !1), (t = Re(Nt(r, o), Nt(e, o), o)), (B = !0), _(t, i));
    };
    v.minus = v.sub = function (e) {
      var t = this;
      return ((e = new t.constructor(e)), t.s == e.s ? io(t, e) : ro(t, ((e.s = -e.s), e)));
    };
    v.modulo = v.mod = function (e) {
      ...
      return r.s ? ((B = !1), (t = Re(r, e, 0, 1).times(e)), (B = !0), r.minus(t)) : _(new n(r), i);
    };
    ...
    v.plus = v.add = function (e) {
      var t = this;
      return ((e = new t.constructor(e)), t.s == e.s ? ro(t, e) : io(t, ((e.s = -e.s), e)));
    };
    v.precision = v.sd = function (e) {
      ...
      if (((t = G(i) + 1), (n = i.d.length - 1), (r = n * U + 1), (n = i.d[n]), n)) {
        for (; n % 10 == 0; n /= 10) r--;
    ...
    v.times = v.mul = function (e) {
      ...
      for (n = f; --n >= 0; ) {
        for (t = 0, i = m + n; i > n; )
          ((a = o[i] + S[n] * C[i - n - 1] + t), (o[i--] = (a % z) | 0), (t = (a / z) | 0));
        o[i] = ((o[i] + t) % z) | 0;
      }
      for (; !o[--s]; ) o.pop();
    ...
    v.toDecimalPlaces = v.todp = function (e, t) {
      ...
      return (
        ...
        e === void 0
          ? r
          : (we(e, 0, ot), t === void 0 ? (t = n.rounding) : we(t, 0, 8), _(r, e + G(r) + 1, t))
      );
    };
    ...
    Re = (function () {
      function e(n, i) {
        var o,
          s = 0,
          a = n.length;
        for (n = n.slice(); a--; ) ((o = n[a] * i + s), (n[a] = (o % z) | 0), (s = (o / z) | 0));
      ...
      return function (n, i, o, s) {
        ...
        for (
          m = n.e - i.e, de = J.length, je = ge.length, S = new yr(Nl), M = S.d = [], f = 0;
          J[f] == (ge[f] || 0);
        )
          ++f;
        if (
          (J[f] > (ge[f] || 0) && --m,
          o == null ? (Q = o = yr.precision) : s ? (Q = o + (G(n) - G(i)) + 1) : (Q = o),
          Q < 0)
        )
          return new yr(0);
        if (((Q = (Q / U + 2) | 0), (f = 0), de == 1))
          for (T = 0, J = J[0], Q++; (f < je || T) && Q--; f++)
            ((F = T * z + (ge[f] || 0)), (M[f] = (F / J) | 0), (T = (F % J) | 0));
        else {
          for (
            T = (z / (J[0] + 1)) | 0,
              T > 1 && ((J = e(J, T)), (ge = e(ge, T)), (de = J.length), (je = ge.length)),
              oe = de,
              R = ge.slice(0, de),
              I = R.length;
            I < de;
...
var Ft,
  ...
  We = ye(() => {
    ...
    ((_t = class {
      ...
      (ut = { webcrypto: Ft, randomUUID: Tr, randomFillSync: Ar, createHash: Co, Hash: _t }));
  });
var Ro = ae(() => {
  "use strict";
  u();
...
var Ra = ae((O) => {
  ...
  O.add4H = Sa;
  var va = (e, t, r, n, i) => (e >>> 0) + (t >>> 0) + (r >>> 0) + (n >>> 0) + (i >>> 0);
  O.add5L = va;
...
var Na = ae((D) => {
  ...
  var Wp = Array.from({ length: 256 }, (e, t) => t.toString(16).padStart(2, "0"));
  function zp(e) {
    (0, gi.abytes)(e);
    let t = "";
...
var Va = ae((q) => {
  ...
  for (let e = 0, t = tr, r = 1, n = 0; e < 24; e++) {
    ...
    let i = od;
    for (let o = 0; o < 7; o++)
      ((t = ((t << tr) ^ ((t >> ad) * ld)) % ud), t & sd && (i ^= tr << ((tr << BigInt(o)) - tr)));
    Fa.push(i);
  }
  var [cd, pd] = (0, rr.split)(Fa, !0),
    Da = (e, t, r) => (r > 32 ? (0, rr.rotlBH)(e, t, r) : (0, rr.rotlSH)(e, t, r)),
    Ma = (e, t, r) => (r > 32 ? (0, rr.rotlBL)(e, t, r) : (0, rr.rotlSL)(e, t, r));
  function $a(e, t = 24) {
  ...
  var nr = class e extends Oe.Hash {
    constructor(t, r, n, i = !1, o = 24) {
      ...
      ((this.state = new Uint8Array(200)), (this.state32 = (0, Oe.u32)(this.state)));
    }
    keccak() {
    ...
    digestInto(t) {
      if (((0, St.aoutput)(t, this), this.finished)) throw new Error("digest() was already called");
...
var _n,
  ...
  ho = !0;
typeof y < "u" &&
  (({ FORCE_COLOR: _n, NODE_DISABLE_COLORS: fo, NO_COLOR: go, TERM: yo } = y.env || {}),
  (ho = y.stdout && y.stdout.isTTY));
var zl = { enabled: !fo && go == null && yo !== "dumb" && ((_n != null && _n !== "0") || ho) };
function $(e, t) {
  let r = new RegExp(`\\x1b\\[${t}m`, "g"),
    n = `\x1B[${e}m`,
    i = `\x1B[${t}m`;
  return function (o) {
    return !zl.enabled || o == null ? o : n + (~("" + o).indexOf(i) ? o.replace(r, i + n) : o) + i;
  };
}
var _g = $(0, 0),
  xr = $(1, 22),
...
function Yl(e) {
  let t = {
    ...
    r = (...n) => {
      ...
      if (
        (n.length !== 0 && Mt.push([o, ...n]), Mt.length > Kl && Mt.shift(), Lt.enabled(o) || i)
      ) {
...
function kr(e) {
  let t = e.showColors ? uc : lc,
    r;
  return (
    typeof $getTemplateParameters < "u" ? (r = $getTemplateParameters(e, t)) : (r = cc(e)), pc(r, t)
  );
}
u();
l();
...
function mc(e) {
  ...
  for (let n of e) {
    ...
    o
      ? t.set(i, {
          ...n,
          argument: { ...n.argument, typeNames: fc(o.argument.typeNames, n.argument.typeNames) },
        })
      : t.set(i, n);
  }
...
function Wo(e, t, r) {
  let n = [`Unknown argument \`${e.red(t)}\`.`],
    i = _c(t, r);
  return (
    i && n.push(`Did you mean \`${e.green(i)}\`?`), r.length > 0 && n.push(Qt(e)), n.join(" ")
  );
}
function vc(e, t) {
  let r;
...
function os(e, t, r) {
  ...
  return !t.result || !(t.result.$allModels || t.result[n])
    ? e
    : $c({ ...e, ...is(t.name, e, t.result.$allModels), ...is(t.name, e, t.result[n]) });
}
function $c(e) {
  let t = new be(),
    r = (n, i) =>
...
var Zn = new WeakMap(),
  ...
  Wt = class {
    constructor(t, r) {
      (Zn.set(this, { sql: t, values: r }), Object.defineProperty(this, jr, { value: jr }));
    }
    get sql() {
...
function Et(e = {}) {
  ...
  return Object.entries(t).reduce(
    (n, [i, o]) => (xs[i] !== void 0 ? (n.select[i] = { select: o }) : (n[i] = o), n),
    { select: {} },
  );
}
function Yc(e = {}) {
...
var vs = (e) => (Array.isArray(e) ? e : e.split(".")),
  ...
  Cs = (e, t, r) =>
    vs(t).reduceRight((n, i, o, s) => Object.assign({}, Xn(e, s.slice(0, o)), { [i]: n }), r);
function np(e, t) {
...
var ri = Symbol();
function Kt(e) {
  let t = [pp(e), dp(e), ie(ri, () => e), ie("$parent", () => e._appliedParent)],
...
function Zt(e) {
  if (typeof e != "object" || e == null || e instanceof Ke.ObjectEnumValue || ht(e)) return e;
      ...
      n === r.length
        ...
        : r[n]({
            ...
            query: (s, a = t) => {
              ...
              return ((a.customDataProxyFetch = qs(o, m)), (a.args = s), Fs(e, a, r, n + 1));
            },
          })
    );
  });
...
function Pt(e, t) {
  ...
  return (r.length < n.length ? r : n).every((o) => {
    ...
    if (Yt.Decimal.isDecimal(e[o]) || Yt.Decimal.isDecimal(t[o])) {
      ...
      if (typeof e[o] == "bigint" || typeof t[o] == "bigint") return Js(e[o]) === Js(t[o]);
      if (typeof e[o] == "number" || typeof t[o] == "number") return Hs(e[o]) === Hs(t[o]);
    }
    return ni(e[o], t[o]);
  });
}
  ...
  switch (r.type) {
      ...
      switch (typeof e) {
        ...
        case "string": {
          ...
          if (Number.isNaN(i) || !Number.isFinite(i))
            throw new V(`Expected an integer in column '${t}', got string: ${e}`);
    ...
    case "decimal":
      if (typeof e != "number" && typeof e != "string" && !Ys.Decimal.isDecimal(e))
        throw new V(`Expected a decimal in column '${t}', got ${typeof e}: ${e}`);
...
function Rd(e, t = Xa) {
  ...
  if (e > Za)
    throw new tt(et.EncodeTimeSizeExceeded, `Cannot encode a time larger than ${Za}: ${e}`);
  ...
  let r,
    n = "";
  for (let i = t; i > 0; i--) ((r = e % sr), (n = Ya.charAt(r) + n), (e = (e - r) / sr));
  return n;
}
function Id() {
...
function Dd(e, t) {
  if (t.pagination) {
    ...
    if ((r !== null && r > 0) || n === 0 || (i !== null && !Pt(e, i))) return null;
  }
...
function _d(e, t, r) {
  ...
  return (i.sort(([o], [s]) => (o < s ? -1 : o > s ? 1 : 0)), i.flatMap(([, o]) => nu(o, t)));
}
...
function Fd(e, t, r, n) {
  ...
  for (let m of Ni(e, r, n)) {
    ...
    if (m.argType.arity === "tuple") {
      ...
      for (let A = 0; A < T / m.argType.elements.length; A++) a.push(...m.argType.elements);
...
function $d(e, t, r) {
  ...
  switch (n) {
    ...
    case "parameterTupleList":
      return e.value
        .map((i) => {
          let o = i.map(() => Oi(t, r.placeholderNumber++)).join(e.itemSeparator);
  ...
  async interpretNode(t, r) {
    switch (t.type) {
      ...
      case "concat": {
        ...
        return { value: n.length > 0 ? n.reduce((i, o) => i.concat(Li(o)), []) : [] };
      }
      case "sum": {
        let n = await Promise.all(t.args.map((i) => this.interpretNode(i, r).then((o) => o.value)));
      ...
      case "execute": {
        ...
        for (let o of n) {
          ...
          i += await this.#u(s, r.queryable, () =>
            r.queryable.executeRaw(s).catch((a) => (t.args.type === "rawSql" ? oi(a) : Tt(a))),
          );
        }
        return { value: i };
      }
        ...
        for (let o of n) {
          let s = cu(o, r.sqlCommenter),
            a = await this.#u(s, r.queryable, () =>
              r.queryable.queryRaw(s).catch((m) => (t.args.type === "rawSql" ? oi(m) : Tt(m))),
            );
      ...
      case "initializeRecord": {
        let { lastInsertId: n } = await this.interpretNode(t.args.expr, r),
          i = {};
        for (let [o, s] of Object.entries(t.args.fields)) i[o] = Gd(s, n, r.scope, r.generators);
        return { value: i, lastInsertId: n };
      }
      case "mapRecord": {
        let { value: n, lastInsertId: i } = await this.interpretNode(t.args.expr, r),
          o = n === null ? {} : ln(n);
        for (let [s, a] of Object.entries(t.args.fields)) o[s] = Wd(a, o[s], r.scope, r.generators);
  ...
  cr = class {
    ...
    async #r(t) {
      ...
      switch (
        ...
        case "waiting":
          if (n.signal.aborted)
            throw (
              o.then((s) => s.rollback()).catch((s) => kt("error in discarded transaction:", s)),
    ...
    #n(t, r) {
      ...
      if (!n) {
        ...
        if (i)
          switch (
            (kt("Transaction already closed.", { transactionId: t, status: i.status }), i.status)
          ) {
            case "closing":
            case "waiting":
            case "running":
            ...
            case "rolled_back":
              throw new pn(r);
            case "timed_out":
              throw new mn(r, { timeout: i.timeout, timeTaken: Date.now() - i.startedAt });
          }
    ...
    #i(t, r) {
      let n = Date.now(),
        i = fu(async () => {
          kt("Transaction timed out.", { transactionId: t, timeoutStartedAt: n, timeout: r });
          let o = this.transactions.get(t);
          o && ["running", "waiting"].includes(o.status)
            ? await this.#o(o, "timed_out")
            : kt("Transaction already committed or rolled back when timeout happened.", t);
        }, r);
      return (i?.unref?.(), i);
    }
    async #o(t, r) {
        ...
        try {
          if (t.transaction && r === "committed")
            if (t.transaction.options.usePhantomQuery)
              ...
              let i = Zd();
              await this.#s(i, t.transaction, () => t.transaction.executeRaw(i)).then(
          ...
          ((t.status = r),
            ...
            this.closedTransactions.length > Kd && this.closedTransactions.shift());
        }
      };
      t.status === "closing"
...
p();
d();
var yu = { bigint: "bigint", date: "datetime", decimal: "decimal", bytes: "bytes" };
function wu(e) {
  let t;
  try {
    t = JSON.parse(e);
...
function Uu(e) {
  ...
  try {
    ...
    let f = m.message;
    throw new rt(`Error validating \`accelerateUrl\`, the URL cannot be parsed, reason: ${f}`, t);
  }
  ...
  if (o === null || o.length < 1)
    throw new rt("Error validating `accelerateUrl`: the URL must contain a valid API key", t);
...
var Bu = te("prisma:client:clientEngine:remoteExecutor"),
  An = class {
    ...
    async startTransaction(t) {
      return {
        ...(await this.#a({ path: "/transaction/start", method: "POST", body: t })),
        payload: void 0,
      };
    }
    async commitTransaction(t) {
    ...
    #n(t) {
      ...
      for (let [i, o] of this.#t) {
        ...
        let s = o.domain ?? t.hostname,
          a = o.path ?? "/";
        t.hostname.endsWith(s) && t.pathname.startsWith(a) && r.push(_u(o.name, o.value));
      }
...
var dr = class {
  ...
  constructor(t, r) {
    ...
    ((this.#r = r ?? ju),
      ...
      this.logQueries &&
        (this.#a = (n) => {
          this.logEmitter.emit("query", { ...n, params: Xt(n.params), target: "ClientEngine" });
        }));
  }
  async #s() {
    switch (this.#t.type) {
  ...
  #c(t, r) {
    ...
    if (t.code === "GenericFailure" && t.message?.startsWith("PANIC:"))
      return new ee.PrismaClientRustPanicError(Qu(this, t.message, r), this.config.clientVersion);
    if (t instanceof Z)
    ...
    try {
      ...
      if (((globalThis.PRISMA_WASM_PANIC_REGISTRY.set_message = i), o))
        throw (
          ...
          new ee.PrismaClientRustPanicError(Qu(this, o, r), this.config.clientVersion)
        );
    }
  }
  onBeforeExit() {
  ...
  async request(t, { interactiveTransaction: r, customDataProxyFetch: n }) {
    ...
    if (Ju(t)) s = Hu(t);
      ...
      A
        ...
        : (Ne("query plan cache miss"), (s = this.#h(m, T, o)), this.#i.setSingle(T, s));
    }
    try {
...
function el(e, t) {
  ...
  if (Xu.Decimal.isDecimal(e)) return { prisma__type: "decimal", prisma__value: e.toJSON() };
  if (g.isBuffer(e)) return { prisma__type: "bytes", prisma__value: e.toString("base64") };
  if (hm(e)) return { prisma__type: "bytes", prisma__value: g.from(e).toString("base64") };
  if (ArrayBuffer.isView(e)) {
    let { buffer: r, byteOffset: n, byteLength: i } = e;
...
var wm = /^(\s*alter\s)/i,
  rl = te("prisma:client");
function Bi(e, t, r, n) {
  if (!(e !== "postgresql" && e !== "cockroachdb") && r.length > 0 && wm.exec(t))
...
var ji =
    ...
    (r) => {
      let n = "",
        i;
      if (Qr(r)) ((n = r.sql), (i = { values: Ot(r.values), __prismaRawParameters__: !0 }));
        ...
        switch (t) {
          case "sqlite":
          case "mysql": {
            ((n = r.sql), (i = { values: Ot(r.values), __prismaRawParameters__: !0 }));
            break;
          }
          case "cockroachdb":
          case "postgresql":
          case "postgres": {
            ((n = r.text), (i = { values: Ot(r.values), __prismaRawParameters__: !0 }));
            break;
          }
          case "sqlserver": {
            ((n = Ku(r)), (i = { values: Ot(r.values), __prismaRawParameters__: !0 }));
            break;
          }
          default:
      ...
      return (
        i?.values ? rl(`prisma.${e}(${n}, ${i.values})`) : rl(`prisma.${e}(${n})`),
  ...
  Cn = class {
    ...
    handleRequestError({
      ...
      if (
        ...
        if (t.isPanic) throw new N.PrismaClientRustPanicError(m, this.client._clientVersion);
        ...
        if (t instanceof N.PrismaClientInitializationError)
          throw new N.PrismaClientInitializationError(m, this.client._clientVersion);
    ...
    sanitizeMessage(t) {
      return this.client._errorFormat && this.client._errorFormat !== "pretty" ? lt(t) : t;
    }
    unpack(t, r, n) {
...
var Lm = { requestArgsToMiddlewareArgs: (e) => e, middlewareArgsToRequestArgs: (e) => e },
